...
# taintgrind/Makefile.  Generated from Makefile.in by configure.
...
noinst_PROGRAMS = taintgrind-x86-linux$(EXEEXT) \
	$(am__EXEEXT_1)
#am__append_2 = taintgrind--linux
taintgrind__linux_DEPENDENCIES =
subdir = taintgrind
...
#am__EXEEXT_1 = taintgrind--linux$(EXEEXT)
PROGRAMS = $(noinst_PROGRAMS)
am__objects_1 =  \
	taintgrind_x86_linux-tg_main.$(OBJEXT)
am_taintgrind_x86_linux_OBJECTS =  \
	$(am__objects_1)
taintgrind_x86_linux_OBJECTS =  \
	$(am_taintgrind_x86_linux_OBJECTS)
am__taintgrind__linux_SOURCES_DIST = tg_main.c
am__objects_2 =  \
	taintgrind__linux-tg_main.$(OBJEXT)
#am_taintgrind__linux_OBJECTS =  \
#	$(am__objects_2)
taintgrind__linux_OBJECTS =  \
	$(am_taintgrind__linux_OBJECTS)
...
SOURCES = $(taintgrind_x86_linux_SOURCES) \
	$(taintgrind__linux_SOURCES)
DIST_SOURCES = $(taintgrind_x86_linux_SOURCES) \
	$(am__taintgrind__linux_SOURCES_DIST)
...
am__relativize = \
  ...
  reldir="$$dir2"
ACLOCAL = ${SHELL} /home/gogo/git/valgrind/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/gogo/git/valgrind/missing --run tar
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/gogo/git/valgrind/missing --run autoconf
AUTOHEADER = ${SHELL} /home/gogo/git/valgrind/missing --run autoheader
AUTOMAKE = ${SHELL} /home/gogo/git/valgrind/missing --run automake-1.11
AWK = gawk
BOOST_CFLAGS = 
BOOST_LIBS = 
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/gogo/git/valgrind/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MPI_CC = mpicc
OBJEXT = o
PACKAGE = valgrind
...
abs_builddir = /home/gogo/git/valgrind/taintgrind
abs_srcdir = /home/gogo/git/valgrind/taintgrind
abs_top_builddir = /home/gogo/git/valgrind
abs_top_srcdir = /home/gogo/git/valgrind
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/gogo/git/valgrind/install-sh
...
pdfdir = ${docdir}
prefix = /home/gogo/git/valgrind/inst
...
NONE_SOURCES_COMMON = tg_main.c
taintgrind_x86_linux_SOURCES = \
	$(NONE_SOURCES_COMMON)

taintgrind_x86_linux_CPPFLAGS = \
	$(AM_CPPFLAGS_X86_LINUX)

taintgrind_x86_linux_CFLAGS = \
	$(AM_CFLAGS_X86_LINUX)

taintgrind_x86_linux_DEPENDENCIES = \
	$(TOOL_DEPENDENCIES_X86_LINUX)

taintgrind_x86_linux_LDADD = \
	$(TOOL_LDADD_X86_LINUX)

taintgrind_x86_linux_LDFLAGS = \
	$(TOOL_LDFLAGS_X86_LINUX)

taintgrind_x86_linux_LINK = \
...
#taintgrind__linux_CPPFLAGS = \
#	$(AM_CPPFLAGS_)

#taintgrind__linux_CFLAGS = \
#	$(AM_CFLAGS_)

#taintgrind__linux_DEPENDENCIES = \
#	$(TOOL_DEPENDENCIES_)

#taintgrind__linux_LDADD = \
#	$(TOOL_LDADD_)

#taintgrind__linux_LDFLAGS = \
#	$(TOOL_LDFLAGS_)

#taintgrind__linux_LINK = \
#	$(top_builddir)/coregrind/link_tool_exe_linux \
#	0xUNSET \
#	$(LINK) \
#	$(taintgrind__linux_CFLAGS) \
...
$(srcdir)/Makefile.in: # $(srcdir)/Makefile.am $(top_srcdir)/Makefile.tool.am $(top_srcdir)/Makefile.all.am $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign taintgrind/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign taintgrind/Makefile
.PRECIOUS: Makefile
...
taintgrind-x86-linux$(EXEEXT): $(taintgrind_x86_linux_OBJECTS) $(taintgrind_x86_linux_DEPENDENCIES) 
	@rm -f taintgrind-x86-linux$(EXEEXT)
	$(taintgrind_x86_linux_LINK) $(taintgrind_x86_linux_OBJECTS) $(taintgrind_x86_linux_LDADD) $(LIBS)
taintgrind--linux$(EXEEXT): $(taintgrind__linux_OBJECTS) $(taintgrind__linux_DEPENDENCIES) 
	@rm -f taintgrind--linux$(EXEEXT)
	$(taintgrind__linux_LINK) $(taintgrind__linux_OBJECTS) $(taintgrind__linux_LDADD) $(LIBS)
...
include ./$(DEPDIR)/taintgrind_x86_linux-tg_main.Po
include ./$(DEPDIR)/taintgrind__linux-tg_main.Po
...
taintgrind_x86_linux-tg_main.o: tg_main.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(taintgrind_x86_linux_CPPFLAGS) $(CPPFLAGS) $(taintgrind_x86_linux_CFLAGS) $(CFLAGS) -MT taintgrind_x86_linux-tg_main.o -MD -MP -MF $(DEPDIR)/taintgrind_x86_linux-tg_main.Tpo -c -o taintgrind_x86_linux-tg_main.o `test -f 'tg_main.c' || echo '$(srcdir)/'`tg_main.c
	$(am__mv) $(DEPDIR)/taintgrind_x86_linux-tg_main.Tpo $(DEPDIR)/taintgrind_x86_linux-tg_main.Po
#	source='tg_main.c' object='taintgrind_x86_linux-tg_main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(taintgrind_x86_linux_CPPFLAGS) $(CPPFLAGS) $(taintgrind_x86_linux_CFLAGS) $(CFLAGS) -c -o taintgrind_x86_linux-tg_main.o `test -f 'tg_main.c' || echo '$(srcdir)/'`tg_main.c

taintgrind_x86_linux-tg_main.obj: tg_main.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(taintgrind_x86_linux_CPPFLAGS) $(CPPFLAGS) $(taintgrind_x86_linux_CFLAGS) $(CFLAGS) -MT taintgrind_x86_linux-tg_main.obj -MD -MP -MF $(DEPDIR)/taintgrind_x86_linux-tg_main.Tpo -c -o taintgrind_x86_linux-tg_main.obj `if test -f 'tg_main.c'; then $(CYGPATH_W) 'tg_main.c'; else $(CYGPATH_W) '$(srcdir)/tg_main.c'; fi`
	$(am__mv) $(DEPDIR)/taintgrind_x86_linux-tg_main.Tpo $(DEPDIR)/taintgrind_x86_linux-tg_main.Po
#	source='tg_main.c' object='taintgrind_x86_linux-tg_main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(taintgrind_x86_linux_CPPFLAGS) $(CPPFLAGS) $(taintgrind_x86_linux_CFLAGS) $(CFLAGS) -c -o taintgrind_x86_linux-tg_main.obj `if test -f 'tg_main.c'; then $(CYGPATH_W) 'tg_main.c'; else $(CYGPATH_W) '$(srcdir)/tg_main.c'; fi`

taintgrind__linux-tg_main.o: tg_main.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(taintgrind__linux_CPPFLAGS) $(CPPFLAGS) $(taintgrind__linux_CFLAGS) $(CFLAGS) -MT taintgrind__linux-tg_main.o -MD -MP -MF $(DEPDIR)/taintgrind__linux-tg_main.Tpo -c -o taintgrind__linux-tg_main.o `test -f 'tg_main.c' || echo '$(srcdir)/'`tg_main.c
	$(am__mv) $(DEPDIR)/taintgrind__linux-tg_main.Tpo $(DEPDIR)/taintgrind__linux-tg_main.Po
#	source='tg_main.c' object='taintgrind__linux-tg_main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(taintgrind__linux_CPPFLAGS) $(CPPFLAGS) $(taintgrind__linux_CFLAGS) $(CFLAGS) -c -o taintgrind__linux-tg_main.o `test -f 'tg_main.c' || echo '$(srcdir)/'`tg_main.c

taintgrind__linux-tg_main.obj: tg_main.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(taintgrind__linux_CPPFLAGS) $(CPPFLAGS) $(taintgrind__linux_CFLAGS) $(CFLAGS) -MT taintgrind__linux-tg_main.obj -MD -MP -MF $(DEPDIR)/taintgrind__linux-tg_main.Tpo -c -o taintgrind__linux-tg_main.obj `if test -f 'tg_main.c'; then $(CYGPATH_W) 'tg_main.c'; else $(CYGPATH_W) '$(srcdir)/tg_main.c'; fi`
	$(am__mv) $(DEPDIR)/taintgrind__linux-tg_main.Tpo $(DEPDIR)/taintgrind__linux-tg_main.Po
#	source='tg_main.c' object='taintgrind__linux-tg_main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(taintgrind__linux_CPPFLAGS) $(CPPFLAGS) $(taintgrind__linux_CFLAGS) $(CFLAGS) -c -o taintgrind__linux-tg_main.obj `if test -f 'tg_main.c'; then $(CYGPATH_W) 'tg_main.c'; else $(CYGPATH_W) '$(srcdir)/tg_main.c'; fi`
